{{-- Panel kalender jadwal: kelas reguler, Holiday Class, & replacement.
     ...
     Butuh: $events (dari App\Support\ScheduleCalendar) & $students. --}}
<style>
    ...
    const calendar = new FullCalendar.Calendar(document.getElementById('calendar'), {
        ...
        eventClick: function (info) {
            ...
            if (stu && matchesStudent(info.event, stu)) {
                ...
                // Kelas reguler tidak punya halaman sendiri, tapi jadwalnya diubah
                // dari form kelas — dan itu pertanyaan berikutnya yang paling wajar
                // setelah melihat satu sesi di kalender.
                link.href = p.editUrl;
    ...
    function visibleEvents() {
        ...
        if (stu) {
            ...
            return events.filter(function (ev) {
                const p = ev.extendedProps || {};
                return matchesStudent(ev, stu) || p.type === 'Holiday Class';
            });
        }
