<footer class="sticky-footer mt-auto py-4">
    <div class="container-fluid px-4">
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
                <span class="text-muted small">&copy; {{ date('Y') }} <span class="fw-bold" style="color: var(--primary-color);">Tarakan Art Class</span>. All rights reserved.</span>
            </div>
